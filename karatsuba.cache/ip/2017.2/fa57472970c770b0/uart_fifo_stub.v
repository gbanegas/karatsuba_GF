...
//               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ uart_fifo_stub.v
// Design      : uart_fifo
...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(rst, wr_clk, rd_clk, din, wr_en, rd_en, dout, full, 
  empty)
/* synthesis syn_black_box black_box_pad_pin="rst,wr_clk,rd_clk,din[17:0],wr_en,rd_en,dout[17:0],full,empty" */;
  input rst;
  input wr_clk;
  input rd_clk;
  input [17:0]din;
